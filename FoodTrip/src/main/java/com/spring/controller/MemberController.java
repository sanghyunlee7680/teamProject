...
public class MemberController {
	...
	public String updateForm(@ModelAttribute("updateMember") Member member, Model model,HttpSession session) {
		...
		System.out.println("이메일 : " + sessionId.getEmail() + " 젠더 : " + sessionId.getGender());
		// Member oneMember = memberService.getOneMember(sessionId);
		// model.addAttribute("updateMember", sessionId);
